...
<div class="flex justify-center mt-10">
  <Card class="w-full max-w-lg p-8 rounded-lg shadow-lg bg-white">
    <h2 class="text-2xl font-bold text-gray-700 mb-6 mt-4 text-center">Transfer Money</h2>
    ...
    <form class="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          required
          class="mt-2 bg-green-500 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-700 placeholder-gray-400"
        />
      </div>
