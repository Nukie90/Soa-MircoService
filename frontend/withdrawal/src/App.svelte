...
<div class="flex justify-center mt-10">
  <Card class="w-full max-w-lg p-8 rounded-lg shadow-lg bg-white">
    <h2 class="text-2xl font-bold text-gray-700 mb-6 mt-4 text-center">Withdraw Money</h2>
    ...
    <form class="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          required
          class="mt-2 bg-yellow-500 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-700 placeholder-gray-400"
        />
      </div>
      ...
      <!-- New Buttons for Transfer, Withdrawal, Deposit -->
      <div class="flex justify-between mt-8">
        <!-- Transfer Button -->
        <Link to="/">
          <Button class="w-36 h-12 bg-green-500 hover:bg-green-700 text-white font-semibold rounded-lg shadow-md transition duration-150 ease-in-out">
            Transfer
          </Button>
        </Link>
        ...
        <!-- Deposit Button -->
        <Link to="/deposit">
          <Button class="w-36 h-12 bg-blue-500 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition duration-150 ease-in-out">
            Deposit
          </Button>
        </Link>
        ...
        <!-- Withdrawal Button -->
        <Link to="/withdrawal">
          <Button class="w-36 h-12 bg-yellow-500 hover:bg-yellow-700 text-white font-semibold rounded-lg shadow-md transition duration-150 ease-in-out">
            Withdrawal
          </Button>
        </Link>
